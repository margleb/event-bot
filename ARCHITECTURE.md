...
Актуально на 31 августа 2026 года. Проект остаётся монолитом на Python: это
...
5. В компании доступны RSVP, чат, место встречи и взаимные запросы на открытие
   Telegram-контактов.
